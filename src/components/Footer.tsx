        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 leading-relaxed mb-6">
              Курс для тех, кто хочет стать разработчиком и научиться мыслить как инженер. 8 месяцев
              интенсивного обучения от практикующих экспертов.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              <li>
                <a href="mailto:info@jsdev-course.com" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Mail className="w-4 h-4" />
                  <span>info@jsdev-course.com</span>
                </a>
              </li>
              <li>
                <a href="tel:+77001234567" className="flex items-center gap-2 hover:text-white transition-colors">
