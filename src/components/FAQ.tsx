...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Вы можете задавать вопросы в чате или назначить дополнительную консультацию с наставником. Мы заинтересованы в вашем успехе и поможем наверстать упущенное.',
    },
    {
    ...
    <section className="bg-white py-20 md:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-br from-slate-900 to-blue-900 rounded-3xl p-8 md:p-12 text-white text-center">
          ...
          <a href='https://t.me/ustazschool_bot' target='_blank' className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all transform hover:scale-105 shadow-xl shadow-blue-500/25">
